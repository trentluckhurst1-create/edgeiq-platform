...
export default function RaceIntelligenceScreen(props: Props): React.ReactElement {
  ...
  useEffect(() => {
    ...
    async function run(): Promise<void> {
      ...
      const [runner, runnerIntel, v8, bet, rel, cards, briefing, marketIntel, verdict, trackIntel, horseDrawer, limitedData, intelligenceScore] = await Promise.all([
  ...
  const enriched = useMemo(() => {
    return raceRows.map((row) => {
      ...
      return { row, runnerIntel, v8, bet, rel, drawer, limited, intel };
    });
  }, [raceRows, runnerIntelRows, v8Rows, betRows, reliabilityRows, horseDrawerRows, limitedDataRows, intelligenceScoreRows]);
