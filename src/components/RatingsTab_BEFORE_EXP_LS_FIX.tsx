            ...
            {sorted.map((runner) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-1 py-2">{metricTile(runner.exp, winningFigure, "EXP", "exp")}</td>
                  <td className="px-1 py-2">{metricTile(runner.todayRating, winningFigure, "TODAY", "today")}</td>
                  <td className="px-1 py-2">{metricTile(runner.ls1, winningFigure, "LS1", "ls")}</td>
                  <td className="px-1 py-2">{metricTile(runner.ls2, winningFigure, "LS2", "ls")}</td>
                  <td className="px-1 py-2">{metricTile(runner.ls3, winningFigure, "LS3", "ls")}</td>
                  <td className="px-1 py-2">{metricTile(runner.ls4, winningFigure, "LS4", "ls")}</td>
                  <td className="px-1 py-2">{metricTile(runner.ls5, winningFigure, "LS5", "ls")}</td>
