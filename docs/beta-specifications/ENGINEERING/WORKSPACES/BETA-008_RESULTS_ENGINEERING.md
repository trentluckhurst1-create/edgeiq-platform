# BETA-008 RESULTS Engineering Specification
...
## 2. Purpose
Show official results, governed performance ratings and benchmark sectionals after completion. The workspace must answer this with governed evidence, not unsupported synthesis. React renders supplied view models only.
...
Runner Performance identity columns are NO, HORSE, JOCKEY, BAR, WT, SP, FINISH, MARGIN, then benchmark sectional columns, then EPI and ERI. Remove Race Replay, EPI versus SP and Race Tempo visual. Benchmark sectionals are lengths: negative green, positive red, zero neutral.
...
- PROPOSED TARGET PATH: `src/edgeiq-os/race/components/ResultsWorkspace.tsx`
- PROPOSED TARGET PATH: `src/edgeiq-os/race/services/resultsFeed.ts`

## 8. Approved Target Architecture
TARGET IMPLEMENTATION CONTRACT: Runner Performance identity columns are NO, HORSE, JOCKEY, BAR, WT, SP, FINISH, MARGIN, then benchmark sectional columns, then EPI and ERI. Remove Race Replay, EPI versus SP and Race Tempo visual. Benchmark sectionals are lengths: negative green, positive red, zero neutral. The component receives a terminal-feed view model. It does not read warehouse files and does not synthesize racing claims.
...
| ResultsWorkspace | PROPOSED TARGET PATH `src/edgeiq-os/race/components/ResultsWorkspace.tsx` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
| resultsFeed | PROPOSED TARGET PATH `src/edgeiq-os/race/services/resultsFeed.ts` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
...
| WINNER | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `winner`. | Table/panel cell for WINNER. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
...
| SP (TAB) | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `sp_tab`. | Table/panel cell for SP (TAB). | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| MARGIN | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `margin`. | Table/panel cell for MARGIN. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| TIME | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `time`. | Table/panel cell for TIME. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
