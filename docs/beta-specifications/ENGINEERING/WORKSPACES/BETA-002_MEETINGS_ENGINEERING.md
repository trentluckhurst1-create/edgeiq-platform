# BETA-002 MEETINGS Engineering Specification
...
## 2. Purpose
Where should the analyst be looking today? The workspace must answer this with governed evidence, not unsupported synthesis. React renders supplied view models only.
...
TODAY, TOMORROW and DAY +2 come from public/data/edgeiq_three_day_window_v1.json. React must not calculate dates. EDGEiQ READ is maximum three short governed evidence phrases. Desktop split is approximately 82 percent main and 18 percent rail with a 16px gap.
...
- PROPOSED TARGET PATH: `src/edgeiq-os/race/components/MeetingsWorkspace.tsx`
- PROPOSED TARGET PATH: `src/edgeiq-os/race/services/meetingsFeed.ts`

## 8. Approved Target Architecture
TARGET IMPLEMENTATION CONTRACT: TODAY, TOMORROW and DAY +2 come from public/data/edgeiq_three_day_window_v1.json. React must not calculate dates. EDGEiQ READ is maximum three short governed evidence phrases. Desktop split is approximately 82 percent main and 18 percent rail with a 16px gap. The component receives a terminal-feed view model. It does not read warehouse files and does not synthesize racing claims.
...
| MeetingsWorkspace | PROPOSED TARGET PATH `src/edgeiq-os/race/components/MeetingsWorkspace.tsx` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
...
| MeetingsWorkspace | PROPOSED TARGET PATH `src/edgeiq-os/race/components/MeetingsWorkspace.tsx` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
| meetingsFeed | PROPOSED TARGET PATH `src/edgeiq-os/race/services/meetingsFeed.ts` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
...
export type BETA002Row = {
    select: string | number | null;
    meeting: string | number | null;
    state: string | number | null;
    rail: string | number | null;
    track: string | number | null;
    weather: string | number | null;
    wind: string | number | null;
    temp: string | number | null;
    races: string | number | null;
    declared: string | number | null;
    scratchings: string | number | null;
    first: string | number | null;
    last: string | number | null;
    status: string | number | null;
    edgeiq_read: string | number | null;
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| SELECT | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `select`. | Table/panel cell for SELECT. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| MEETING | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `meeting`. | Table/panel cell for MEETING. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| STATE | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `state`. | Table/panel cell for STATE. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| RAIL | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `rail`. | Table/panel cell for RAIL. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| TRACK | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `track`. | Table/panel cell for TRACK. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| WEATHER | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `weather`. | Table/panel cell for WEATHER. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| WIND | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `wind`. | Table/panel cell for WIND. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| TEMP | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `temp`. | Table/panel cell for TEMP. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| RACES | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `races`. | Table/panel cell for RACES. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| DECLARED | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `declared`. | Table/panel cell for DECLARED. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| SCRATCHINGS | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `scratchings`. | Table/panel cell for SCRATCHINGS. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| FIRST | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `first`. | Table/panel cell for FIRST. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| LAST | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `last`. | Table/panel cell for LAST. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| STATUS | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `status`. | Table/panel cell for STATUS. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| EDGEiQ READ | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `edgeiq_read`. | Table/panel cell for EDGEiQ READ. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| OPEN | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `open`. | Table/panel cell for OPEN. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |

```json
{
  "workspace_id": "BETA-002",
