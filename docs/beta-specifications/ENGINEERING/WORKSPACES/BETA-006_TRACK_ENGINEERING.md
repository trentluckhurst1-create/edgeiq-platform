# BETA-006 TRACK Engineering Specification
...
## 2. Purpose
Explain official track, rail, physical profile and governed track-pattern analysis. The workspace must answer this with governed evidence, not unsupported synthesis. React renders supplied view models only.
...
Official fields include Official Rating, Inspection Time, Going Stick, Penetrometer Average, Moisture, Rain 24h, Rain 7d, Irrigation 24h, Irrigation 7d and Track Manager. Remove Track Record and Class Record. Use Track Pattern Analysis, not Track Bias as primary heading.
...
- PROPOSED TARGET PATH: `src/edgeiq-os/race/components/TrackWorkspace.tsx`
- PROPOSED TARGET PATH: `src/edgeiq-os/race/services/trackFeed.ts`

## 8. Approved Target Architecture
TARGET IMPLEMENTATION CONTRACT: Official fields include Official Rating, Inspection Time, Going Stick, Penetrometer Average, Moisture, Rain 24h, Rain 7d, Irrigation 24h, Irrigation 7d and Track Manager. Remove Track Record and Class Record. Use Track Pattern Analysis, not Track Bias as primary heading. The component receives a terminal-feed view model. It does not read warehouse files and does not synthesize racing claims.
...
| TrackWorkspace | PROPOSED TARGET PATH `src/edgeiq-os/race/components/TrackWorkspace.tsx` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
| trackFeed | PROPOSED TARGET PATH `src/edgeiq-os/race/services/trackFeed.ts` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
...
export type BETA006Row = {
    metric: string | number | null;
    today: string | number | null;
    last_3_meetings: string | number | null;
    last_10_meetings: string | number | null;
    source: string | null;
    sourceTimestamp: string | null;
    sourceConfidence: 'official' | 'governed' | 'derived' | 'unavailable' | null;
};

export type BETA006ViewModel = {
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| METRIC | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `metric`. | Table/panel cell for METRIC. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
...
| LAST 3 MEETINGS | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `last_3_meetings`. | Table/panel cell for LAST 3 MEETINGS. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| LAST 10 MEETINGS | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `last_10_meetings`. | Table/panel cell for LAST 10 MEETINGS. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |

```json
{
  "workspace_id": "BETA-006",
  ...
  "rows": [
    {
      "metric": null,
      "today": null,
      "last_3_meetings": null,
      "last_10_meetings": null
    }
  ]
}
```
...
- `src/edgeiq-os/race/components/TrackWorkspace.tsx`
- `src/edgeiq-os/race/services/trackFeed.ts`
