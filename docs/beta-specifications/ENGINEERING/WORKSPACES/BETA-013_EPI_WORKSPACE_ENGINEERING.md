# BETA-013 EPI WORKSPACE Engineering Specification
...
## 1. Document Control
- Specification ID: BETA-013
- Workspace: EPI WORKSPACE
- Version: V1
...
## 2. Purpose
Show each runner previous EPI ratings across up to 10 official starts in historical race-strength context. The workspace must answer this with governed evidence, not unsupported synthesis. React renders supplied view models only.
...
Hover card fields include Date, Track, Meeting / Race, Distance, Class, Condition, Barrier, Weight, Jockey, Trainer, Finish, Margin, SP, EPI, ERI, 8-6, 6-4, 4-2, 2-F, Source and Version. Missing starts are blank neutral cells, never zero. React must not calculate averages, peak, trend or tile class.
...
- PROPOSED TARGET PATH: `src/edgeiq-os/race/components/EpiWorkspaceWorkspace.tsx`
- PROPOSED TARGET PATH: `src/edgeiq-os/race/services/epi_workspaceFeed.ts`

## 8. Approved Target Architecture
TARGET IMPLEMENTATION CONTRACT: Hover card fields include Date, Track, Meeting / Race, Distance, Class, Condition, Barrier, Weight, Jockey, Trainer, Finish, Margin, SP, EPI, ERI, 8-6, 6-4, 4-2, 2-F, Source and Version. Missing starts are blank neutral cells, never zero. React must not calculate averages, peak, trend or tile class. The component receives a terminal-feed view model. It does not read warehouse files and does not synthesize racing claims.
...
| EpiWorkspaceWorkspace | PROPOSED TARGET PATH `src/edgeiq-os/race/components/EpiWorkspaceWorkspace.tsx` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
| epi_workspaceFeed | PROPOSED TARGET PATH `src/edgeiq-os/race/services/epi_workspaceFeed.ts` | Typed view-model props only; preserve current mounted props during migration. | Selection/hover/focus/filter/expansion only. | Typed callbacks for navigation and row selection. | Builder/service; React display-only. | Unit, integration and visual audit. |
...
export type BETA013Row = {
    ...
    current_epi: string | number | null;
    rank: string | number | null;
    field_avg: string | number | null;
    diff: string | number | null;
    start_10: string | number | null;
    start_9: string | number | null;
    start_8: string | number | null;
    start_7: string | number | null;
    start_6: string | number | null;
    start_5: string | number | null;
    start_4: string | number | null;
    start_3: string | number | null;
    start_2: string | number | null;
    start_1: string | number | null;
    source: string | null;
...
| CURRENT EPI | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `current_epi`. | Table/panel cell for CURRENT EPI. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| RANK | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `rank`. | Table/panel cell for RANK. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| FIELD AVG | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `field_avg`. | Table/panel cell for FIELD AVG. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| DIFF | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `diff`. | Table/panel cell for DIFF. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 10 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_10`. | Table/panel cell for START 10. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 9 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_9`. | Table/panel cell for START 9. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 8 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_8`. | Table/panel cell for START 8. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 7 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_7`. | Table/panel cell for START 7. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 6 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_6`. | Table/panel cell for START 6. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 5 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_5`. | Table/panel cell for START 5. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 4 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_4`. | Table/panel cell for START 4. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 3 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_3`. | Table/panel cell for START 3. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 2 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_2`. | Table/panel cell for START 2. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
| START 1 | Canonical builder listed in this spec. | Governed `public/data` terminal feed. | Workspace service/normaliser. | `start_1`. | Table/panel cell for START 1. | Do not coerce to zero, average, neutral or invented text. | Contract audit verifies presence, null count and format. |
...
| 3 | CURRENT EPI | `current_epi` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 4 | RANK | `rank` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 5 | FIELD AVG | `field_avg` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 6 | DIFF | `diff` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 7 | START 10 | `start_10` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 8 | START 9 | `start_9` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 9 | START 8 | `start_8` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 10 | START 7 | `start_7` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 11 | START 6 | `start_6` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 12 | START 5 | `start_5` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 13 | START 4 | `start_4` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 14 | START 3 | `start_3` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 15 | START 2 | `start_2` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
| 16 | START 1 | `start_1` | Governed feed field mapped by service. | string/number/status | Null remains blank, unavailable or pending. | Racing display format; never raw JSON. | 76 | centre | Builder-supported only. | Builder-supported only. | Source/timestamp/null reason. | Open route only if implemented. | Focus follows visual order. | Reduced opacity and SCRATCHED label where applicable. | Horizontal scroll; do not cardify desktop table. |
...
- `src/edgeiq-os/race/services/epi_workspaceFeed.ts`
