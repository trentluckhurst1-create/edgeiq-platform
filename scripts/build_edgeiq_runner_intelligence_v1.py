...
for _, r in merged.iterrows():
    ...
    rows.append({
        ...
        "pricing_status": first_val(r, ["V6_1_RESEARCH_price_status"]),
...
diag = pd.DataFrame([{
    ...
    "with_fair_price": int((out["fair_price"].notna() & out["pricing_status"].eq("RESEARCH_RATED")).sum()),
    "with_any_fair_price": int(out["fair_price"].notna().sum()),
