...
OUT = PUBLIC / "edgeiq_vic_historical_sectional_warehouse_v1.csv"
DIAG = PUBLIC / "edgeiq_vic_historical_sectional_warehouse_diagnostics_v1.csv"
...
def parse_page(page):
    ...
    for idx in range(row_count):
        ...
        row["source"] = "RACINGCOM_DOM_HISTORICAL_V1"
...
print("=" * 100)
print("EDGEIQ VIC HISTORICAL SECTIONAL WAREHOUSE V1")
print("=" * 100)
