...
TARGET = ROOT / "scripts" / "build_edgeiq_racingcom_ingestion_v2_foundation.py"
CHECKPOINT = ROOT / "scripts" / "build_edgeiq_racingcom_ingestion_v2_foundation_CHECKPOINT_BEFORE_VERIFIED_RACES_20260722.py"
...
if not CHECKPOINT.exists():
    CHECKPOINT.write_text(TARGET.read_text(encoding="utf-8", errors="replace"), encoding="utf-8")
TARGET.write_text(NEW_CODE.lstrip(), encoding="utf-8")
