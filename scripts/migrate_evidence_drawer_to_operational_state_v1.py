...
drawer = Path("src/edgeiq-os/command/components/EvidenceDrawer.tsx")
...
text = text.replace(
  '<EvidenceDrawer activeEvidence={activeEvidence} onClose={() => setActiveEvidence("")} />',
  '<EvidenceDrawer activeEvidence={activeEvidence} evidence={raceState.evidence} onClose={() => setActiveEvidence("")} />'
)

workspace.write_text(text, encoding="utf-8")

print("[EDGEIQ] EvidenceDrawer migrated to OperationalRaceState evidence")
