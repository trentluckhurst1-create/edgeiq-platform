...
path = root / 'scripts' / 'audit_edgeiq_race_entry_suitability_aggregate_fact_v1.py'
checkpoint = root / 'docs' / 'victoria-performance-intelligence-race-context-authority-v1' / 'checkpoints' / 'audit_edgeiq_race_entry_suitability_aggregate_fact_v1_PRE_CURRENT_AGGREGATE_AUDIT_ALIGNMENT.py'
