...
def main():
    ...
    wcsv(DOCS/'edgeiq_timing_canonical_migration_audit_v1.csv',['check','status','detail'],[
      ...
      {'check':'canonical_historical_timing_rows','status':'PASS' if rows(CAN['timing_warehouse'])==70308 else 'FAIL','detail':str(rows(CAN['timing_warehouse']))},
