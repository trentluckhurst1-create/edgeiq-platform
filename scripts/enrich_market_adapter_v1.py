...
path = Path("src/edgeiq-os/services/adapters/MarketAdapter.ts")
  ...
  buildModuleOutput: () => {
    ...
    return {
      ...
      feedHealth: {
        ...
        label: "Market",
        status: "READY",
        freshness: `Snapshot ${snapshot.context.track} R${snapshot.context.raceNo}; ${rows.length} market row(s)`,
      },
    };
  },
};
...
print("[EDGEIQ] Market adapter enriched")
