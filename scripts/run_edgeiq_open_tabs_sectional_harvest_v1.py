...
OUT = PUBLIC / "edgeiq_vic_open_tabs_sectional_warehouse_v1.csv"
DIAG = PUBLIC / "edgeiq_vic_open_tabs_sectional_warehouse_diagnostics_v1.csv"
...
with sync_playwright() as p:
    ...
    for pg in context.pages:
        ...
        try:
            ...
            if (
                "racing.com/form/" in pg.url
                and "speed-data" in pg.url
            ):

                speed_pages.append(pg)

        except:
            pass

    print("=" * 100)
    print("VISIBLE SPEED DATA TABS:", len(speed_pages))
    print("=" * 100)

    for page in speed_pages:
        ...
        try:
            ...
            for idx in range(row_count):
                ...
                row["source"] = "RACINGCOM_OPEN_TABS_V1"
...
print("=" * 100)
print("EDGEIQ OPEN TABS SECTIONAL WAREHOUSE")
print("=" * 100)
