...
OUT = DATA / "edgeiq_pricing_replay_spine_v3_3_temperature6.csv"
SUMMARY = DATA / "edgeiq_pricing_replay_spine_v3_3_temperature6_summary.csv"
AUDIT = DATA / "edgeiq_pricing_replay_spine_v3_3_temperature6_audit.csv"

TEMP = 6.0

print("[PRICING_REPLAY_SPINE_V3_3_TEMPERATURE6] START")
...
summary = pd.DataFrame([{
    ...
    "status": "PRICING_REPLAY_SPINE_V3_3_TEMPERATURE6_BUILT_RESEARCH_ONLY"
}])

summary.to_csv(SUMMARY, index=False)

print("[PRICING_REPLAY_SPINE_V3_3_TEMPERATURE6] COMPLETE")
print(f"out={OUT}")
