...
EXPLAIN = DATA / "edgeiq_runner_explainability_v1_1.csv"
CONF = DATA / "edgeiq_confidence_breakdown_v1.csv"
TREND = DATA / "edgeiq_runner_trend_engine_v1.csv"

OUT = DATA / "edgeiq_explainability_terminal_feed_v1_1.csv"
SUMMARY = DATA / "edgeiq_explainability_terminal_feed_v1_1_summary.csv"
...
def main():
    ...
    summary_rows = [
        {"metric": "status", "value": "EXPLAINABILITY_TERMINAL_FEED_V1_1_BUILT"},
