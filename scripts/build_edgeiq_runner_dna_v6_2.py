...
OUT = DATA / "edgeiq_live_runner_dna_v6_2.csv"
SUMMARY = DATA / "edgeiq_runner_dna_v6_2_summary.csv"
...
summary_rows = [
    {"metric": "status", "value": "RUNNER_DNA_V6_2_BUILT"},
...
print("[RUNNER_DNA_V6_2] COMPLETE")
