...
OUT_FILE = DATA / "edgeiq_runner_score_v3.csv"
AUDIT_FILE = DATA / "edgeiq_runner_score_v3_audit.csv"
...
def main():
    ...
    out["runner_score_engine"] = "RUNNER_SCORE_V3"
    out["runner_score_inputs_v3"] = "strength_v4|runner_score_v2_compressed|pace|shape|hidden|predictability|live_race_strength|vulnerability|governance_penalty"
    ...
    print("[RUNNER_SCORE_V3] COMPLETE")
