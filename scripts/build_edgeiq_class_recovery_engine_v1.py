...
OUT = PUBLIC / "edgeiq_class_recovery_engine_v1.csv"
AUDIT = PUBLIC / "edgeiq_class_recovery_engine_v1_audit.csv"
SUMMARY = PUBLIC / "edgeiq_class_recovery_engine_v1_summary.csv"

print("=" * 96)
print("EDGEIQ CLASS RECOVERY ENGINE V1")
print("=" * 96)
...
def recover_class(row):
    ...
    if m:
        val = int(m.group(1))
        return {"race_class_recovered": f"BM{val}", "class_recovery_status": "RECOVERED", "class_recovery_reason": "zero_to_rating_token"}
