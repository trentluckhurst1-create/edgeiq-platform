...
REPORT = ROOT / 'docs' / 'product-specification' / 'FORM_GUIDE_FINAL_VIEW_MODEL_APPLY_V2.json'
CHECKS = [('normaliser_used', 'tsx', 'normaliseFormGuideRace'), ('enriched_feed_used', 'tsx', 'loadFormGuideEnrichedFeed'), ('rich_runner_preferred', 'tsx', 'recentRuns.length >= 3'), ('no_model_math', 'tsx', 'edgeiqPrice')]
