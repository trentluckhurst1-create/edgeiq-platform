...
def main() -> None:
    ...
    for observation_id in sorted(eligibility_by_id):
        ...
        for unavailable_field in (
            ...
            if canonical_text(observation[unavailable_field]):
                fail(
                    f"{observation_id}: {unavailable_field} unexpectedly "
                    "contains source evidence. V1 contract must be reviewed."
                )
        ...
        group_rows.append(
            {
                ...
                "official_distance_metres": distance,
                "course_name": "",
                "course_name_status": UNAVAILABLE_STATUS,
                "surface": "",
                "surface_status": UNAVAILABLE_STATUS,
                "track_condition": "",
                "track_condition_status": UNAVAILABLE_STATUS,
