...
TARGET = ROOT / "scripts" / "build_edgeiq_racingcom_race_discovery_v2.py"
CHECKPOINT = ROOT / "scripts" / "build_edgeiq_racingcom_race_discovery_v2_CHECKPOINT_PRE_GRAPHQL_EVIDENCE_20260723.py"
    ...
    print(
        {
            ...
            "patched_utc": datetime.utcnow().isoformat(timespec="seconds") + "Z",
        }
    )
    return 0
