...
root = Path("src/edgeiq-os/services/operational-reasoning")
root.mkdir(parents=True, exist_ok=True)

(root / "OperationalReasoningTypes.ts").write_text(r'''
...
(root / "OperationalReasoningService.ts").write_text(r'''
...
export * from "./OperationalReasoningTypes";
export * from "./OperationalReasoningService";
''', encoding="utf-8")

print("[EDGEIQ] Operational Reasoning Engine created")
