...
INFILE = os.path.join(DATA, "edgeiq_projection_v6_research_prior_rating_backtest.csv")

OUT = os.path.join(DATA, "edgeiq_v6_vs_v5_prior_rank1_head_to_head.csv")
SUMMARY = os.path.join(DATA, "edgeiq_v6_vs_v5_prior_rank1_head_to_head_summary.csv")
...
v6 = rank1[rank1["model"] == "V6_RESEARCH_PRIOR"].copy()
