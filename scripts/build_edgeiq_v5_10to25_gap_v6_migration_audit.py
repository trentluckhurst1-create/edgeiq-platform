...
x["v5_gap_bucket"] = x["v5_rating_gap"].apply(bucket)
x["v6_gap_bucket"] = x["v6_rating_gap"].apply(bucket)

summary = (
    x.groupby(["v5_gap_bucket","v6_gap_bucket"])
    .agg(
...
summary = summary.sort_values(["v5_gap_bucket","v6_gap_bucket"])

summary.to_csv(
    r".\public\data\edgeiq_v5_10to25_gap_v6_migration_audit.csv",
    index=False
)
