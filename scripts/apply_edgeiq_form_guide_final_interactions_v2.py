...
REPORT = ROOT / 'docs' / 'product-specification' / 'FORM_GUIDE_FINAL_INTERACTIONS_APPLY_V2.json'
CHECKS = [('expand_button', 'tsx', 'eiq-form-runner-expand'), ('aria_expanded', 'tsx', 'aria-expanded={isExpanded}'), ('scroll_to_runner', 'tsx', 'scrollToRunner'), ('tooltip_portal', 'tsx', 'createPortal')]
