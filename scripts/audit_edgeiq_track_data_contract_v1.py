...
DETAIL_FIELDS = ["TRACK TYPE", "SURFACE", "CIRCUMFERENCE", "STRAIGHT"]
...
checks = {
    ...
    "view_model_statuses_present": all(status in service for status in ["loading", "empty", "unavailable", "stale", "error", "current"]),
