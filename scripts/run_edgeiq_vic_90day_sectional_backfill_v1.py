...
OUT = PUBLIC / "edgeiq_vic_historical_sectional_warehouse_v2.csv"
DIAG = PUBLIC / "edgeiq_vic_historical_sectional_warehouse_v2_diagnostics.csv"
    ...
    while current <= END_DATE:
        ...
        for track in TRACKS:
            ...
            for race_no in range(1, 11):
                ...
                url = f"https://www.racing.com/form/{race_date}/{track}/race/{race_no}/speed-data"
                ...
                try:
                    ...
                    for idx in range(parsed["rows"]):
                        ...
                        row["source"] = "RACINGCOM_DOM_HISTORICAL_V2"
                    ...
                    diagnostics.append({
                        ...
                        "race_no": race_no,
                        "status": "SUCCESS",
                        "rows_created": parsed["rows"],
                        "meet_code": parsed["meet_code"]
                    })

                    print("SUCCESS ROWS:", parsed["rows"])
...
print("=" * 100)
print("EDGEIQ VIC HISTORICAL SECTIONAL WAREHOUSE V2")
print("=" * 100)
