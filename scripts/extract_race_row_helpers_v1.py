...
utils = root / "src" / "utils" / "raceRowHelpers.ts"
utils.write_text('''import { num, text } from "./edgeiqFormat";
...
if count != 1:
    raise SystemExit("[ERROR] race row helper block not replaced")

import_line = 'import { distance, firstNum, firstText, horse, integer, raceClass, raceDate, raceNo, railPosition, track, trackCondition } from "../utils/raceRowHelpers";'
...
print("[RACE_ROW_HELPERS_EXTRACT] complete")
