...
TARGET = ROOT / "scripts" / "build_edgeiq_race_entry_context_parameter_selection_fact_v1.py"
CHECKPOINT = ROOT / "docs" / "victoria-performance-intelligence-completion-v1" / "checkpoints" / "build_edgeiq_race_entry_context_parameter_selection_fact_v1_PRE_EMPTY_INPUT_GUARD.py"
CHECKPOINT.parent.mkdir(parents=True, exist_ok=True)
if not CHECKPOINT.exists():
    CHECKPOINT.write_text(TARGET.read_text(encoding="utf-8"), encoding="utf-8")
text = TARGET.read_text(encoding="utf-8")
text = text.replace(
    'BUILDER_VERSION = (\n    "edgeiq_race_entry_context_parameter_selection_fact_v1.0.0"\n)',
