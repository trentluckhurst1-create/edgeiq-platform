...
OUT = DATA / "edgeiq_runner_dna_v6_2_weight_replay_v1.csv"
BY_RACE = DATA / "edgeiq_runner_dna_v6_2_weight_replay_v1_by_race.csv"
SUMMARY = DATA / "edgeiq_runner_dna_v6_2_weight_replay_v1_summary.csv"
...
summary = pd.DataFrame([
    ["status", "RUNNER_DNA_V6_2_WEIGHT_REPLAY_V1_BUILT"],
    ["source", SRC.name],
    ["rows", len(out)],
    ["races", len(by_race)],
...
print("[RUNNER_DNA_V6_2_WEIGHT_REPLAY_V1] COMPLETE")
