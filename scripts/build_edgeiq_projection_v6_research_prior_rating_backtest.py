...
OUT_DETAIL = os.path.join(DATA, "edgeiq_projection_v6_research_prior_rating_backtest.csv")
OUT_SUMMARY = os.path.join(DATA, "edgeiq_projection_v6_research_prior_rating_backtest_summary.csv")
OUT_BY_BAND = os.path.join(DATA, "edgeiq_projection_v6_research_prior_rating_backtest_by_band.csv")
OUT_VS_PROD = os.path.join(DATA, "edgeiq_projection_v6_research_prior_rating_backtest_vs_production.csv")
OUT_JSON = os.path.join(DATA, "edgeiq_projection_v6_research_prior_rating_backtest_summary.json")
...
def main():
    ...
    v6_bt = build_prior_model(v6, "V6_RESEARCH_PRIOR", "performance_rating_v6_research")
    ...
    res = s[s["model"] == "V6_RESEARCH_PRIOR"].iloc[0].to_dict()
    ...
    for k in s.columns:
        ...
        try:
            ...
            delta = ""
        comp.append({"metric": k, "production_v5_1_prior": a, "v6_research_prior": b, "delta": delta})
